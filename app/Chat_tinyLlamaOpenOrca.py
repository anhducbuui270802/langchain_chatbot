...
i_temperature = 0.30 # mức độ sáng tạo của câu trả lời
i_max_new_tokens=1100 # số lượng từ tối đa mà mô hình có thể tạo ra
modelfile = "models/tinyllama-1.1b-1t-openorca.Q4_K_M.gguf" # đường dẫn đến mô hình
i_repetitionpenalty = 1.2 # giảm sự lặp lại của từ
i_contextlength=12048 # độ dài của bộ nhớ ngắn hạn
